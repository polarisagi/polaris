...
func RustSandboxExec(cfg NativeSandboxCfg, timeoutMs uint64) (*RustSandboxResponse, error) {
	...
	if err != nil {
		return nil, perrors.Wrap(perrors.CodeInternal, "rust_native_sandbox: marshal request", err)
	}
...
func RustSandboxProbeTools() (map[string]any, error) {
	...
	if err := json.Unmarshal([]byte(jsonStr), &result); err != nil {
		return nil, perrors.Wrap(perrors.CodeInternal, "rust_native_sandbox: unmarshal probe", err)
	}
	return result, nil
}
