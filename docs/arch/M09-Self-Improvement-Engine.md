...
> **§跳读**: 0-bis:6 职责 / 0-ter:20 不变量速查 / 1:33 五路线(CANONICAL) / 2:91 三环嵌套 / 3-bis:193 EvalGenerator / 3:221 五级演化+审批 / 4:252 条件梯度 / 6:276 369(SOFT)降级 / 7:304 依赖
## 0-bis. 职责边界
...
6. LLM 生成 (每技能 ≤10, 总 ≤50/周期，使用 DeepSeek V4 Pro 以保证难度阶梯质量), 目标难度 = currentHigh
7. 生成后安全审查（四阶段）:
