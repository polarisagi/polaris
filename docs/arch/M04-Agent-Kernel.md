...
<!-- §跳读: 0-bis:13 职责 / 0-ter:26 不变量速查 / 1:44 状态机 / 2:99 Suspend-on-Idle / 3:115 S_VALIDATE / 4:164 DAG（Directed Acyclic Graph，有向无环图） / 5:251 System1/2 / 6:275 WorldModel / 7:286 推理预算 / 8:345 CrashRecovery / 8-bis:391 Handoff唤醒事件化+无损续跑 / 12:401 已知Bug修复记录 / 13:410 (SOFT)降级 / 14:428 跨模块契约 / 15:452 默认参数 -->
## 0-bis. 职责边界
