...
| inv_M8_06 | 委托链深度 ≤3——跨 Agent 委托禁止超过 3 层 | M11 §8 Layer 4 多 Agent 宪法 | ⚠️ 计划中：TaskEntry.SpawnDepth 字段存在，但 Orchestrator/Blackboard 未在 PostTask 时校验 |
...
| 委托链深度 ≤3 校验（inv_M8_06） | ⚠️ P1 | SpawnDepth 字段存在，PostTask 时无校验逻辑 |
