...
- **日期**: 2026-05-21
- **决策者**: AI Architect
- **相关模块**: M7 Tool Action Layer / `internal/extension/mcp/`
...
- `internal/extension/mcp/mcp_client.go`（Streamable HTTP 实现；MCP Client 层已迁移至 L2 扩展层 `internal/extension/mcp/`）
...
| 2026-06-13 | 引用路径更新：internal/extension/mcp/mcp_manager.go → internal/extension/mcp/mcp_client.go；mcp_transport.go 不存在 |
