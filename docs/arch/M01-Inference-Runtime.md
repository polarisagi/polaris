...
<!-- §跳读: 0:12 职责 / 0-ter:26 不变量速查 / 1:41 默认模型 / 2:47 Provider接口 / 3:55 Adapter / 4:82 Router / 4.4:98 ComplexityDeterminer / 4.5:107 Route方法 / 5:162 Token预算 / 6:240 SemanticCache / 7:286 Fallback / 8:350 本地推理local_only / 9:403 ModelVersion / 12:440 349(SOFT)降级 / 13:475 依赖 -->
