...
> **代码位置**：根目录
>
<!-- §跳读: 0-bis:8 哲学 / 0:16 SSoT / 1:24 定位约束 / 2:73 49(SOFT)部署 / 3:86 Staging / 4:112 HT0预算 / 5:141 变更控制 / 6:157 配置层 -->
...
Stage 4: replay_shadow        (M12 历史 trajectory 重放对比；⚠️ 依赖的 ShadowExecutor 2026-07-07 复核确认未实现,见 M12 §4/§8)
