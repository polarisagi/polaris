...
<!-- §跳读: 0-bis:6 职责 / 0-ter:21 不变量速查 / 1:35 对外接口 / 2:436 对内调度 / 3:556 MCP / 6:574 (SOFT)降级 / 6-bis:587 已知Bug修复记录 / 7:599 跨模块契约 / 8:616 Web UI 规约 / 8.6:762 插件聚合市场DB+流 / 8.7:798 自动化中心DB+流+工作流 / 8.8:914 电脑操控权限+Preferences / 8.9:954 前端组件规范 -->
## 0-bis. 职责边界
