...
> **§跳读**: 0-bis:6 职责 / 0-ter:21 不变量速查 / 1:34 对外接口 / 2:286 对内调度 / 3:386 MCP / 6:397 (SOFT)降级 / 7:414 跨模块契约 / 8:431 Web UI 规约 / 8.6:插件聚合市场DB+流 / 8.7:自动化中心DB+流+工作流 / 8.8:电脑操控权限+Preferences
## 0-bis. 职责边界
