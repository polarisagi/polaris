...
type ActionFacade interface {
	...
	ExecuteCode(ctx context.Context, req codeact.CodeActRequest) (*codeact.CodeActResult, error)
...
func (f *ActionFacadeImpl) ExecuteCode(ctx context.Context, req codeact.CodeActRequest) (*codeact.CodeActResult, error) {
	if f.ca == nil {
