...
func TestExecuteAction_Disabled(t *testing.T) {
	e := NewComputerUseEngine(LAMConfig{Enabled: false}, &mockProvider{}, nil, &mockPolicyGate{})
...
func TestExecuteAction_NilProvider(t *testing.T) {
	e := NewComputerUseEngine(LAMConfig{Enabled: true}, nil, nil, &mockPolicyGate{})
...
func TestExecuteAction_NilScreenState(t *testing.T) {
	e := NewComputerUseEngine(LAMConfig{Enabled: true}, &mockProvider{}, nil, &mockPolicyGate{})
...
func TestExecuteAction_DryRun_ReturnsActionJSON(t *testing.T) {
	...
	e := NewComputerUseEngine(LAMConfig{Enabled: true, ResolverModel: "mock"}, provider, nil, &mockPolicyGate{})
...
func TestExecuteAction_WithExecutor_Success(t *testing.T) {
	...
	e := NewComputerUseEngine(LAMConfig{Enabled: true}, provider, executorFn, &mockPolicyGate{})
...
func TestExecuteAction_InvalidVLMResponse(t *testing.T) {
	...
	e := NewComputerUseEngine(LAMConfig{Enabled: true}, provider, nil, &mockPolicyGate{})
