...
func TestExecuteAction_Disabled(t *testing.T) {
	e := NewComputerUseEngine(LAMConfig{Enabled: false}, &mockProvider{}, nil, &mockPolicyGate{}, nil)
...
func TestExecuteAction_NilProvider(t *testing.T) {
	e := NewComputerUseEngine(LAMConfig{Enabled: true}, nil, nil, &mockPolicyGate{}, nil)
...
func TestExecuteAction_NilScreenState(t *testing.T) {
	e := NewComputerUseEngine(LAMConfig{Enabled: true}, &mockProvider{}, nil, &mockPolicyGate{}, nil)
...
func TestExecuteAction_DryRun_ReturnsActionJSON(t *testing.T) {
	...
	e := NewComputerUseEngine(LAMConfig{Enabled: true, ResolverModel: "mock"}, provider, nil, &mockPolicyGate{}, nil)
...
func TestExecuteAction_WithExecutor_Success(t *testing.T) {
	...
	e := NewComputerUseEngine(LAMConfig{Enabled: true}, provider, executorFn, &mockPolicyGate{}, nil)
...
func TestExecuteAction_InvalidVLMResponse(t *testing.T) {
	...
	e := NewComputerUseEngine(LAMConfig{Enabled: true}, provider, nil, &mockPolicyGate{}, nil)
