...
// 2026-07-14：内存版 RegistryImpl 删除后（ADR-0062），SQLiteRegistryImpl 是
...
// 2026-07-14（ADR-0062）：从已删除的内存版 RegistryImpl 同名测试移植，避免删除
...
// 2026-07-14（ADR-0062）：从已删除的内存版 RegistryImpl 同名测试移植。
