...
func (s *ToolStage) semanticFilter(queryVec []float32, entries []catalog.CatalogEntry) []types.ToolSchema {
	type scored struct {
...
func (s *ToolStage) toSchemas(entries []catalog.CatalogEntry) []types.ToolSchema {
...
func (s *ToolStage) toSchema(e catalog.CatalogEntry) types.ToolSchema {
