...
func TestStepScorer_SuccessAllPassed(t *testing.T) {
	...
	ctx := stepCtx{ToolResult: true, SchemaPassed: true, LatencyMs: 0, TokensUsed: 0}
...
func TestStepScorer_FailureLowersScore(t *testing.T) {
	...
	ctxOK := stepCtx{ToolResult: true, SchemaPassed: true}
	ctxFail := stepCtx{ToolResult: false, SchemaPassed: true}
...
func TestStepScorer_SchemaFailLowersScore(t *testing.T) {
	...
	ctxPassed := stepCtx{ToolResult: true, SchemaPassed: true}
	ctxFailed := stepCtx{ToolResult: true, SchemaPassed: false}
