...
func allowedUploadExts() map[string]bool {
	return map[string]bool{
		// 图片
		".jpg": true, ".jpeg": true, ".png": true, ".gif": true, ".webp": true, ".bmp": true, ".ico": true, ".svg": true,
		// 视频
		".mp4": true, ".webm": true, ".mov": true, ".avi": true, ".mkv": true,
		// 音频
		".mp3": true, ".wav": true, ".ogg": true, ".flac": true, ".m4a": true,
		// 文档/数据
		".pdf": true, ".txt": true, ".md": true, ".csv": true, ".json": true, ".yaml": true, ".yml": true,
		".docx": true, ".xlsx": true, ".pptx": true, ".zip": true, ".tar": true, ".gz": true,
	}
}
...
func (h *SysAdminHandler) HandleVFSUpload(w http.ResponseWriter, r *http.Request) {
	...
	err = h.SystemRepo.UpsertVFSRef(r.Context(), vfsURI, size, time.Now().Unix())
	if err != nil {
