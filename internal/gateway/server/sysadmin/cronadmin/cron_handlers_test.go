...
func TestCronHandlers(t *testing.T) {
	...
	ca.HandleListAutomations(w, req)
	...
	w = httptest.NewRecorder()
	ca.HandleCreateAutomation(w, req)
	...
	w = httptest.NewRecorder()
	ca.HandleUpdateAutomation(w, req)
	if w.Result().StatusCode != http.StatusOK {
	...
	req.SetPathValue("id", "auto-1")
	w = httptest.NewRecorder()
	ca.HandleTriggerAutomation(w, req)
	...
	req.SetPathValue("id", "auto-1")
	w = httptest.NewRecorder()
	ca.HandleListAutomationRuns(w, req)
	if w.Result().StatusCode != http.StatusOK {
	...
	req.SetPathValue("id", "auto-1")
	w = httptest.NewRecorder()
	ca.HandleDeleteAutomation(w, req)
