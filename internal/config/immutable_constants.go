...
// 架构文档: docs/arch/M09-Self-Improvement-Engine.md §3,
//           docs/arch/M11-Policy-Safety.md §1
...
// 白名单见下方 return 列表（本注释此前长期与实际返回值不一致，误写"internal/swarm/**,
// internal/extension/skill/**, internal/memory/**, pkg/edge/**"——2026-07-12
...
func ImmutableKernelPackages() []string {
	return []string{
		...
		// PolicyGate，HE-2 可验证执行边界）。2026-07-12 前物理位于 internal/execute/dag/，
